...
| Gemini CLI / Antigravity | `~/.cache/gemini/tmp/<project_hash>/chats/` or `~/.gemini/{antigravity,antigravity-cli,antigravity-ide}/brain/` |
...
> **Note**: The Session Manager covers the six session sources listed above (where Gemini CLI includes Antigravity sessions); the Claude Desktop entry reuses the Claude Code session view.
...
- **OpenCode**
- **OpenClaw**
- **Gemini CLI** (includes Antigravity)
- **Hermes**
